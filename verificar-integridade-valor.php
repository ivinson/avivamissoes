          ...
          <!-- TITULO e cabeçalho das paginas  -->
                <div class="page-title">
                    <div class="row">
                        ...
                        <a href='extrato-processamento.php?id={$rowOption['id']}' class='btn btn-info' role='button'><span class='glyphicon glyphicon-ok-circle' aria-hidden='true'></span> Importar Extrato Bradesco</a><br>
                    </div>
                </div>
                <!-- /.row -->
