<?php
     ...
     */
    $aColumns = array( 'id', 'Nome', 'Email', 'Cidade', 'UF','idTipoUsuario' );
    ...
    {
        fatal_error( 'Puxa! Não conseguimos conectar com o bando de dados.Tente novamente...' );
    }
 
    if ( ! mysql_select_db( $gaSql['db'], $gaSql['link'] ) )
    {
        fatal_error( 'Opa! Alguma coisa aconteceu! Vamos tentar denovo? ' );
    }
