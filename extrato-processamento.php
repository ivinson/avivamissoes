...
<div class="page-title">
  <div class="row">
    <div class="col-12 col-md-6 order-md-1 order-last">
      <h3><img src="images/logo_bradesco.png" alt="logo bradesco" width="150"><?= $tituloPrincipal ?><br><br>
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="form-group">
        ...
        <br><br>
        <input class="btn btn-light" id="imagem" name="imagem" type="file">
        <input type='hidden' value='1' name='submitted' />
        <br>
        <input class="btn btn-success mt-3" type="submit" value="Importar">
      </div>
